        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            <div className="bg-white shadow-md rounded-xl p-6">
              ...
              <Link href={`/city/${city.slug}/saasservice`}>
  <button className="w-full sm:w-auto py-2 px-6 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-300 ease-in-out mb-3">
    Check It
  </button>
</Link>
